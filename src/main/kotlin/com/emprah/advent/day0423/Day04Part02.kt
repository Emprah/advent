...
private const val taskId = "Day04Part02"
...
class Day04Part02 (
    ...
    override fun solve() {
        ...
        val cardCount = calculator.getCardCountWithDuplication(fileContent)
        logger.info { "Number of all scratchcards (with duplication) equals $cardCount" }
    }
}